...
*/
 ...
 [FN1] = LAYOUT_60_ansi( /* FN1 */
    ...
    _______, _______,   KC_UP, _______, _______, _______, _______, _______, _______, KC_PAUS, KC_PSCR, KC_HOME, KC_END, TG(FN3),
    KC_CAPS, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______, _______, _______, _______, KC_SYRQ, KC_PGUP, KC_PGDN, ______,
 ...
 [FN2] = LAYOUT_60_ansi( /* FN2 */
    _______, KC_AP2_BT1, KC_AP2_BT2, KC_AP2_BT3, KC_AP2_BT4, _______, _______, _______, _______, _______, _______, _______, _______, TG(FN5),
  ...
  * |        |     |QKMWU |     |     |    |     |     |     |     |    |      |     |   FN3  |
  * |-----------------------------------------------------------------------------------------+
  * |         |QKMWL|QKMWD|QKMWR|     |     |QKMCL|QKMCD|QKMCU|QKMCR|     |     |             |
  * |-----------------------------------------------------------------------------------------+
  * |            |MBTN3|MBTN1|MBTN2|     |     |     |     |     |     |     |                |
  * |-----------------------------------------------------------------------------------------+
  * |       |       |       |                                 |       |       |       |       |
 ...
 [FN3] = LAYOUT_60_ansi( /* FN3 */
    ...
    _______, _______,    MS_WHLU,    _______,    _______,    _______, _______, _______, _______, _______, _______, _______, _______, TG(FN3),
    _______, MS_WHLL,    MS_WHLD,    MS_WHLR,    _______,    _______, MS_LEFT, MS_DOWN,   MS_UP, MS_RGHT, _______, _______, _______,
    _______,             MS_BTN3,    MS_BTN1,    MS_BTN2,    _______, _______, _______, _______, _______, _______, _______, _______,
    _______, _______,    _______,                                     _______,                   _______, _______, _______, _______
 ),
  /*
  * Layer FN4
 ...
 [FN5] = LAYOUT_60_ansi( /* FN5 */
    ...
    LT(FN4, KC_SCRL), KC_A,    KC_R,    KC_S, KC_T, KC_G, KC_RBRC,     KC_M, KC_N, KC_E,    KC_I,     KC_O,           KC_ENT,
    KC_LSFT,                   KC_Z,    KC_X, KC_C, KC_D,    KC_V,  KC_SLSH, KC_K, KC_H, KC_COMM,   KC_DOT,          KC_RSFT,
    KC_LCTL,       KC_LGUI, KC_LALT,                       KC_SPC,              KC_RALT, MO(FN1),  TG(FN5),          KC_RCTL
 ),
};
// clang-format on
